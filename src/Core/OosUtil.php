...
class OosUtil
{
    public const OOS_CONTENT = 'content';

    public const OOS_LENGTH = 'length';

    public const OOS_HEADERS = 'headers';

    public const OOS_MAX_OBJECT_GROUP_VALUE = 1000;

    public const OOS_MAX_PART_SIZE = 5368709120; // 5GB

    public const OOS_MID_PART_SIZE = 10485760; // 10MB

    public const OOS_MIN_PART_SIZE = 102400; // 100KB

    /**
     * Generate query params.
     *
     * @param array $options: a key-value pair array
     * @param null|mixed $cmpFunction
     * @return string: the key-value list in the format such as key1=value1&key2=value2
     */
    public static function toQueryString($options = [], $cmpFunction = null)
    {
        $temp = [];
