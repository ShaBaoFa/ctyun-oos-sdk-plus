<?php
namespace Wlfpanda1012\CtyunOosSdkPlus\OOS;

use Wlfpanda1012\CtyunOosSdkPlus\OOS\Core\MimeTypes;
use Wlfpanda1012\CtyunOosSdkPlus\OOS\Core\OosException;
use Wlfpanda1012\CtyunOosSdkPlus\OOS\Http\RequestCore;
use Wlfpanda1012\CtyunOosSdkPlus\OOS\Http\RequestCore_Exception;
use Wlfpanda1012\CtyunOosSdkPlus\OOS\Http\ResponseCore;
use Wlfpanda1012\CtyunOosSdkPlus\OOS\Model\CorsConfig;
use Wlfpanda1012\CtyunOosSdkPlus\OOS\Model\LoggingConfig;
use Wlfpanda1012\CtyunOosSdkPlus\OOS\Result\AclResult;
use Wlfpanda1012\CtyunOosSdkPlus\OOS\Result\GetCorsResult;
use Wlfpanda1012\CtyunOosSdkPlus\OOS\Result\GetPolicyResult;
use Wlfpanda1012\CtyunOosSdkPlus\OOS\Result\GetLifecycleResult;
use Wlfpanda1012\CtyunOosSdkPlus\OOS\Result\GetLocationResult;
use Wlfpanda1012\CtyunOosSdkPlus\OOS\Result\GetLoggingResult;

use Wlfpanda1012\CtyunOosSdkPlus\OOS\Result\GetAccelerateResult;
use Wlfpanda1012\CtyunOosSdkPlus\OOS\Result\GetSessionTokenResult;
use Wlfpanda1012\CtyunOosSdkPlus\OOS\Result\GetWebsiteResult;
use Wlfpanda1012\CtyunOosSdkPlus\OOS\Result\HeaderResult;
use Wlfpanda1012\CtyunOosSdkPlus\OOS\Result\InitiateMultipartUploadResult;
use Wlfpanda1012\CtyunOosSdkPlus\OOS\Result\ListBucketsResult;
use Wlfpanda1012\CtyunOosSdkPlus\OOS\Result\ListMultipartUploadResult;
use Wlfpanda1012\CtyunOosSdkPlus\OOS\Model\ListMultipartUploadInfo;
use Wlfpanda1012\CtyunOosSdkPlus\OOS\Result\ListObjectsResult;
use Wlfpanda1012\CtyunOosSdkPlus\OOS\Result\ListPartsResult;
use Wlfpanda1012\CtyunOosSdkPlus\OOS\Result\PutSetDeleteResult;
use Wlfpanda1012\CtyunOosSdkPlus\OOS\Result\DeleteObjectsResult;
use Wlfpanda1012\CtyunOosSdkPlus\OOS\Result\CopyObjectResult;
use Wlfpanda1012\CtyunOosSdkPlus\OOS\Result\CallbackResult;
use Wlfpanda1012\CtyunOosSdkPlus\OOS\Result\ExistResult;
use Wlfpanda1012\CtyunOosSdkPlus\OOS\Result\AppendResult;
use Wlfpanda1012\CtyunOosSdkPlus\OOS\Result\RegionsResult;
use Wlfpanda1012\CtyunOosSdkPlus\OOS\Result\CreateAccessKeyResult;
use Wlfpanda1012\CtyunOosSdkPlus\OOS\Result\ListAccessKeyResult;
use Wlfpanda1012\CtyunOosSdkPlus\OOS\Result\GetObjectResult;
use Wlfpanda1012\CtyunOosSdkPlus\OOS\Model\ObjectListInfo;
use Wlfpanda1012\CtyunOosSdkPlus\OOS\Result\UploadPartResult;
use Wlfpanda1012\CtyunOosSdkPlus\OOS\Model\BucketListInfo;
use Wlfpanda1012\CtyunOosSdkPlus\OOS\Model\LifecycleConfig;
use Wlfpanda1012\CtyunOosSdkPlus\OOS\Model\RefererConfig;
use Wlfpanda1012\CtyunOosSdkPlus\OOS\Model\WebsiteConfig;
use Wlfpanda1012\CtyunOosSdkPlus\OOS\Core\OosUtil;
use Wlfpanda1012\CtyunOosSdkPlus\OOS\Model\ListPartsInfo;

use Wlfpanda1012\CtyunOosSdkPlus\OOS\Config\DomainConfig;
use Wlfpanda1012\CtyunOosSdkPlus\OOS\Config\Config;
...
use Wlfpanda1012\CtyunOosSdkPlus\OOS\Model\BucketRegion;

use Wlfpanda1012\CtyunOosSdkPlus\OOS\Model\InitiateMultipartUploadInfo;
use Wlfpanda1012\CtyunOosSdkPlus\OOS\Model\CopyPartInfo;

use Wlfpanda1012\CtyunOosSdkPlus\OOS\Result\CompleteMultipartUploadResult;
use Wlfpanda1012\CtyunOosSdkPlus\OOS\Model\CompleteMultipartUploadInfo;

use Wlfpanda1012\CtyunOosSdkPlus\OOS\Result\DeleteUpdateAccessKeyResult;
...
use Wlfpanda1012\CtyunOosSdkPlus\OOS\Result\HeaderObjectResult;
/**
 * Class OosClient
 *
...
class OosClient
{
    ...
    */
    ...
    public function listObjects($bucket, $options = NULL)
    {
        ...
        {
            // 注释原有代码，delimiter为空字符串可列出所有问题，为"/"时只能列出一层
    ...
    public function GetSessionToken($options = NULL)
    {
        ...
        $time = $options[self::DURATION_SECONDS] ?? 3600;
...
//        return $this->auth($options);
        ...
        // fix: 附件自定义名字 by 卫凌峰
        if(isset($options["response-content-disposition"]))
            $signable_query_string_params["response-content-disposition"] = $options["response-content-disposition"];
        ...
        if(isset($options["response-content-disposition"]))
            // fix: 附件自定义名字 by 卫凌峰
            // 2次encode为了应对浏览器自带的decode
            $signed_url .= "&" . "response-content-disposition" . "=" . rawurlencode($options["response-content-disposition"]);
    ...
    private function authV2($options)
    {
        ...
        $signable_query_string = OosUtil::toQueryString($signable_query_string_params);
        $resource_uri = $this->generateResourceUri($options);
        \Log::info('v2_resource_uri: '.$resource_uri);
