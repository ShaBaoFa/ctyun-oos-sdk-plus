...
namespace Wlfpanda1012\CtyunOosSdkPlus\Http;

use OOS\Http\binary;
use OOS\Http\function;
use OOS\Http\headers;
...
class RequestCore
{
     ...
     */
    public $request_class = 'Wlfpanda1012\CtyunOosSdkPlus\Http\RequestCore';

    /**
     * The default class to use for HTTP Responses (defaults to <ResponseCore>).
     */
    public $response_class = 'Wlfpanda1012\CtyunOosSdkPlus\Http\ResponseCore';
